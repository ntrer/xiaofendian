<template>
	<view>
		...
		<view class="flex align-center text-color" style="height: 80rpx;background-color: #fff;">
			...
			<view class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 28upx;height: 100rpx;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;">
				<text>奖品名称</text>
				<input style="text-align: end;" type="text" v-model="awardName1" placeholder="输入奖品名称" placeholder-style="color: #9F9F9F;text-align: end;" />
			</view>
			<view class="pl-2 pr-2">
				<divider :height="4"></divider>
			</view>	
			...
			<view v-if="value1=='兑换券'" class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 32upx;height: 100rpx;">
				<text>奖品名称</text>
				<input style="text-align: end;" type="text" v-model="duihuanAwardName1" placeholder="奖品名称不超过20个字" placeholder-style="color: #9F9F9F;text-align: end;" />
			</view>
			...
			<view class="" v-if="awardNum==2">
				...
				<view class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 28upx;height: 100rpx;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;">
					<text>奖品名称</text>
					<input style="text-align: end;" type="text" v-model="awardName2" placeholder="输入奖品名称" placeholder-style="color: #9F9F9F;text-align: end;" />
				</view>
				<view class="pl-2 pr-2">
					<divider :height="4"></divider>
				</view>	
				...
				<view v-if="value3=='兑换券'" class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 32upx;height: 100rpx;">
					<text>奖品名称</text>
					<input style="text-align: end;" type="text" v-model="duihuanAwardName2"  placeholder="奖品名称不超过20个字" placeholder-style="color: #9F9F9F;text-align: end;" />
				</view>
			...
			<view class="" v-if="awardNum==3">
				...
				<view class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 28upx;height: 100rpx;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;">
					<text>奖品名称</text>
					<input style="text-align: end;" type="text" v-model="awardName3" placeholder="输入奖品名称" placeholder-style="color: #9F9F9F;text-align: end;" />
				</view>
				<view class="pl-2 pr-2">
					<divider :height="4"></divider>
				</view>	
				...
				<view v-if="value5=='兑换券'" class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 32upx;height: 100rpx;">
					<text>奖品名称</text>
					<input style="text-align: end;" type="text"  v-model="duihuanAwardName3" placeholder="奖品名称不超过20个字" placeholder-style="color: #9F9F9F;text-align: end;" />
				</view>
			...
			<view class="" v-if="awardNum==4">
				...
				<view class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 28upx;height: 100rpx;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;">
					<text>奖品名称</text>
					<input style="text-align: end;" type="text" v-model="awardName4" placeholder="输入奖品名称" placeholder-style="color: #9F9F9F;text-align: end;" />
				</view>
				<view class="pl-2 pr-2">
					<divider :height="4"></divider>
				</view>	
				...
				<view v-if="value7=='兑换券'" class="flex align-center justify-between text-color pl-2 pr-2" style="font-size: 32upx;height: 100rpx;">
					<text>奖品名称</text>
					<input style="text-align: end;" type="text" v-model="duihuanAwardName4" placeholder="奖品名称不超过20个字" placeholder-style="color: #9F9F9F;text-align: end;" />
				</view>
