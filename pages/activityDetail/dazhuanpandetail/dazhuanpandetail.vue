<template>
	<view>
		<u-navbar :is-back="true" title="大转盘-活动详情" title-color="#000" title-width="400" :background="background"></u-navbar>
		...
		<view class=" mt-3 flex align-center justify-between bg-white" style="height: 100rpx;">
			<view class="flex align-center">
				<view class="main-bg-color" style="width: 8rpx;height: 36rpx;"></view>
				<text style="font-size: 32rpx;font-weight: 600;" class="ml-2">抽奖记录</text>
			</view>
		...
		<view class=" bg-white flex align-center justify-center" style="height: 120rpx;display: none;">
			<text style="color: #8A8A8A;">还没有人参与，赶紧邀请客户抽奖</text>
		</view>
