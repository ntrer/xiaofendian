<template>
	<view>
		<u-navbar title="推荐有礼-活动记录" :background="background" title-color="#000" title-width="400" :isBack="true" ></u-navbar>
		
		<view class="flex align-center justify-between bg-white mt-1" style="height: 100rpx;box-shadow: 0px 2px 5px 0px rgba(0, 0, 0, 0.0);">
			<view class="flex flex-1 align-center  text-color  flex-column" style="height: 100rpx; font-size: 28rpx;" @click="switchType(1)">
				<text style="margin-top: 30rpx;" :class="checkedIndex==1?'font-bold':''">推荐人记录</text>
				<view v-if="checkedIndex==1" class="main-bg-color" style="width: 120rpx;height: 8rpx;margin-top: 22rpx;"></view>
			</view>
			
			<view class="flex flex-1 align-center text-color flex-column" style="height: 100rpx;font-size: 28rpx;" @click="switchType(2)">
				<text style="margin-top: 30rpx;" :class="checkedIndex==2?'font-bold':''">礼品发放记录</text>
				<view v-if="checkedIndex==2" class="main-bg-color" style="width: 140rpx;height: 8rpx;margin-top: 22rpx;"></view>
			</view>
		</view>
		...
		<view class="" v-for="(item,index) in 3" :key="index">
			<view class="flex align-center justify-between" >
				...
				<view class="flex align-end flex-column pr-2" >
					<text style="font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;font-size: 28upx;">推荐好友：5位</text>
