<template>
	<view>
		<u-navbar :is-back="true" title="砸金蛋-活动详情" title-color="#000" title-width="400" :background="background"></u-navbar>
		
		<divider :height="20"></divider>
		<!-- 今日数据 标题-->
		<view class="flex flex-row align-center justify-between pt-2 bg-white">
			...
			<view class="flex align-center justify-between mr-2" @click="toZhongJiang()">
				<text style="color: #1D1200;">中奖统计</text>
		...
		<view class=" mt-3 flex align-center justify-between bg-white" style="height: 100rpx;">
			<view class="flex align-center">
				<view class="main-bg-color" style="width: 8rpx;height: 36rpx;"></view>
				<text style="font-size: 32rpx;font-weight: 600;" class="ml-2">砸蛋记录</text>
			</view>
		...
		<view class=" bg-white flex align-center justify-center" style="height: 120rpx;display: none;">
			<text style="color: #8A8A8A;">还没有人参与，赶紧邀请客户砸金蛋</text>
		</view>
		...
		<view class="flex align-center justify-between">
			...
			<view class="flex align-end flex-column pr-2" >
				<text style="font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;font-size: 28upx;">未中奖</text>
		...
		<u-modal v-model="showPop" :title-style="{color: '#000',fontSize:'50upx',fontWeight:'600'}" title="确认结束活动"
		 ...
		 @confirm="sureClose()">
			<view class="flex  flex-column pl-3 pr-3 text-color mt-1 align-center justify-center" style="height: 140rpx;font-family: PingFangSC-Regular, PingFang SC;font-weight: 400;color: #1D1200;font-size: 28upx;">
				<text>结束活动后无法抽奖，请谨慎操作</text>
				<text>注：奖品仍然可以核销</text>	
			</view>
		</u-modal>
