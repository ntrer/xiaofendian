<template>
	<view>
		...
		<!-- 确定按钮 -->
		<view class="flex align-center justify-center ml-4 mr-4 mt-5" style="height: 76rpx;background: linear-gradient(139deg, #FF8337 0%, #FF7200 100%, #FF7200 100%);border-radius: 40rpx;color: #fff;font-size: 32rpx;">
			查询
		</view>
