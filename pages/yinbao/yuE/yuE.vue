<template>
	<view>
		...
		<view class="main-bg-color flex align-center justify-center" style="height: 360rpx;">
			<view class="flex align-center justify-center flex-column" style="margin-top: -80rpx;">
				<view class="flex align-center justify-center mt-4" @click="showDes()">
					<text class="mr-1" style="font-size: 36rpx;">余额</text>
					<view class="rounded-circle flex align-center justify-center" style="height: 24rpx;width: 24rpx; border: #000000 solid 1rpx;">
						<text class="text-center" style="font-size: 20upx;color: #000;">!</text>
					</view>
				</view>
				<text class=" mt-1 font-bold" style="font-size: 50upx;color: #000;">0</text>
...
box-shadow: 0px 0px 25rpx 0px rgba(0, 0, 0, 0.1);">
		...
		<view class="flex align-center justify-between" style="height: 120rpx;font-size: 36rpx;padding-top: 20rpx;">
		...
		<view class="flex flex-column" v-for="(item,index) in 2" :key="index">
			...
			<view class="flex flex-row align-center justify-between" style="height: 140rpx;">
				...
				<view class="flex align-center justify-center flex-column ml-2 mt-4">
					<text style="font-size: 34rpx;color: #1D1200;">收入—商城订单</text>
				...
				<view class="flex align-center justify-between flex-row mt-2">
					<text class="text-checked-color" style="font-size: 40rpx;">+0.01</text>
		...
		<u-modal v-model="show" :title-style="{color: '#000',fontSize:'40upx',fontWeight:'600'}" title="温馨提示"
		 :show-confirm-button="false" >
			<view class="flex  flex-column pl-3 pr-3 text-color mt-2" style="height: 360rpx;">
				<text>1.店铺/分销商所赚取的佣金会默认存入余额账户</text>	
				<text class="mt-1">2.余额账户金额默认提现至微信钱包</text>	
				<text class="mt-1">3.未启用银行卡结算账户时，店铺收款默认存入店铺余额</text>	
				
				<view class=" flex align-center justify-center mt-3 font-bold ml-5 mr-5" style="background-color:#FF7200;border-radius: 40rpx; color: #fff;height: 60rpx;" @click="showDes()">
					<text>知道了</text>
				</view>
