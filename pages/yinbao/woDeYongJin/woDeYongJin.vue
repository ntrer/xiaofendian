<template>
	<view style="background-color: #F4F4F4;min-height: 100vh;">
		<u-navbar title="我的佣金"  :background="background" title-color="#000" :isBack="true"></u-navbar>
		...
		<!-- 佣金列表 -->
		<view class="flex flex-column" style="background-color: #fff;" v-for="(item,index) in 5" :key="index">
			<view class="flex justify-between align-center pl-3 pr-3">
				<view class="flex flex-column justify-center" style="height: 130rpx;">
					<text class="text-color" style="font-size: 26rpx;">小天使用我分享的打折活动优惠券</text>
					<text class="mt-2" style="font-size: 24rpx;color: #828282;">2020/1/18  15 : 35 : 17</text>
				</view>
				
				<text class="font-bold" style="font-size: 32rpx;color: #4CB811;">+1.0元</text>
			</view>
